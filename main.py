...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'AdaptViG training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=128, type=int) # 128 normally, 16 GPUs, so 2048 effective batch size, 64 * 8 = 512 batch, 32 * 16 = 512 batch
    parser.add_argument('--gradient_accumulation', default=False, type=bool) 
    parser.add_argument('--epochs', default=300, type=int)

    # Model parameters
    parser.add_argument('--model', default='AdaptViG_S', type=str, metavar='MODEL',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'AdaptViG training and evaluation script', parents=[get_args_parser()])
